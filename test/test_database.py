...
class TestReorderTablesForSQL(TestCase):
    ...
    def test_reorder_tables(self) -> None:
        ...
        refs = [
            ...
            Mock(type=ONE_TO_MANY, table1=t1, table2=t2, inline=False),  # ignored not inline
        ...
        result = reorder_tables_for_sql(original, refs)

...
class TestColumnSettings(TestCase):
    ...
    def test_refs(self) -> None:
        ...
        res = column_settings.parse_string('[ref: - table.column, ref: < table2.column2]', parseAll=True)
        self.assertEqual(len(res[0]['ref_blueprints']), 2)

    def test_note_default(self) -> None:
        res = column_settings.parse_string('[default: 123, note: "mynote"]', parseAll=True)
